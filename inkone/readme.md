...
Added a pimoroni trackball:
- https://docs.qmk.fm/#/feature_pointing_device?id=pimoroni-trackball

Linking this keymap in qmk
    
    cd qmk/keyboards/lilly/keymaps
    ln -s ../<path to this repo>inkone inkone
